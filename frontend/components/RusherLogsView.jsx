const RusherLogsView = ({rushing_log_id, game_id, player_id, carries, yards, touchdowns, fantasy_points}) => {
    return(
        ...
        <h2 className="text-lg font-semibold mb-4">Running Back Log</h2>
